...
from app.services.strategies.bollinger_reversion import register_bollinger_reversion_strategy
from app.services.strategies.donchian_breakout import register_donchian_breakout_strategy
...
from app.services.strategies.mean_reversion import register_mean_reversion_strategy
from app.services.strategies.momentum import register_momentum_strategy
...
def register_builtin_strategies(registry: StrategyRegistry = strategy_registry) -> StrategyRegistry:
    ...
    register_momentum_strategy(registry)
    register_rsi_mean_reversion_strategy(registry)
    register_breakout_strategy(registry)
    register_mean_reversion_strategy(registry)
    register_bollinger_reversion_strategy(registry)
    register_donchian_breakout_strategy(registry)
