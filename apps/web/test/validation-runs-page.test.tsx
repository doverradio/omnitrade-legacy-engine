...
function installStatefulFetchMock() {
  const state = {
    runs: [
      {
        validation_run_id: "11111111-1111-1111-1111-111111111111",
  ...
  const fetchMock = vi.fn(async (input: string | URL | Request, init?: RequestInit) => {
    ...
    if (url.pathname === "/validation-runs" && method === "GET") {
      return jsonResponse(200, {
        items: state.runs.map((item) => ({ ...item })),
      });
    }
    ...
    if (url.pathname === "/validation-runs" && method === "POST") {
      ...
      state.runs = [...state.runs, { ...created, status: "RUNNING" }];
    ...
    if (url.pathname === "/validation-runs/22222222-2222-2222-2222-222222222222/start" && method === "POST") {
      return jsonResponse(200, {
        ...
        initial_metrics: state.metricsByRunId["22222222-2222-2222-2222-222222222222"],
      });
    }

    if (url.pathname === "/validation-runs/11111111-1111-1111-1111-111111111111/metrics" && method === "GET") {
      state.metricsByRunId["11111111-1111-1111-1111-111111111111"] = {
        ...state.metricsByRunId["11111111-1111-1111-1111-111111111111"],
        elapsed_percentage: state.metricsByRunId["11111111-1111-1111-1111-111111111111"].elapsed_percentage + 1,
      };
      return jsonResponse(200, state.metricsByRunId["11111111-1111-1111-1111-111111111111"]);
    }

    if (url.pathname === "/validation-runs/22222222-2222-2222-2222-222222222222/metrics" && method === "GET") {
      return jsonResponse(200, state.metricsByRunId["22222222-2222-2222-2222-222222222222"]);
    }
...
describe("ValidationRunsPage", () => {
  ...
  it("keeps the existing selection when a second validation run is started", async () => {
    ...
    expect(screen.getByText("72h Proving")).toBeInTheDocument();
    expect(screen.getByText("Started From Form")).toBeInTheDocument();
  });
});
